...
FluxSinglePhaseLiquidAdimensionalized::FluxSinglePhaseLiquidAdimensionalized(const FluxSinglePhaseLiquidAdimensionalized &copy) : FluxFunction(copy.fluxParams()){
    ...
    FluxSinglePhaseLiquidAdimensionalized_Params *p = (FluxSinglePhaseLiquidAdimensionalized_Params*)(&(copy.fluxParams()));

    thermo = copy.thermo;
}

FluxSinglePhaseLiquidAdimensionalized::FluxSinglePhaseLiquidAdimensionalized(const FluxSinglePhaseLiquidAdimensionalized_Params &param, Thermodynamics *t) : FluxFunction(param){
    ...
    FluxSinglePhaseLiquidAdimensionalized_Params *p = (FluxSinglePhaseLiquidAdimensionalized_Params*)(&param);
