...
FloatSettings :: FloatSettings() :
	Settings(TEXTBOX_FLOAT)
{
}


FloatProfile * FloatSettings :: profile()
{
	FloatProfile * profile = new FloatProfile(
		ID(), 			\
		type(), 		\
		visible(), 		\
		changeable(),		\
...
string FloatSettings :: toXML(int _level)
{
