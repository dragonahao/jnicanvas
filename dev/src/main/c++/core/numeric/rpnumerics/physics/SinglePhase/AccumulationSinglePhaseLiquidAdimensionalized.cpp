...
//    double mc = copy.accumulationParams().component(0);
//    double mw = copy.accumulationParams().component(1);
//    double Press = copy.accumulationParams().component(2);
//    double Tr = copy.accumulationParams().component(3);
//    double Tw = copy.accumulationParams().component(4);
//    double Cr = copy.accumulationParams().component(5);
//    double cw = copy.accumulationParams().component(6);
//    double T_typical = copy.accumulationParams().component(7);
//    double Rho_typical = copy.accumulationParams().component(8);
//    double U_typical = copy.accumulationParams().component(9);
//    double h_typical = copy.accumulationParams().component(10);

    phi = copy.accumulationParams().component(11);

    AccumulationSinglePhaseLiquidAdimensionalized_Params *p = (AccumulationSinglePhaseLiquidAdimensionalized_Params*)(&(copy.accumulationParams()));

    thermo = copy.thermo;
}

AccumulationSinglePhaseLiquidAdimensionalized::AccumulationSinglePhaseLiquidAdimensionalized(const AccumulationSinglePhaseLiquidAdimensionalized_Params &param, Thermodynamics *t) : AccumulationFunction(param){
...
int AccumulationSinglePhaseLiquidAdimensionalized::jet(const WaveState &w, JetMatrix &m, int degree) const{
    ...
    if (degree >= 0){
        ...
        if (degree >= 1){
            ...
            double dG0_dxc        = phi*drhoac_dxc;
            double dG0_dTheta     = phi*drhoac_dTheta;
            double dG0_dU         = 0.0;

            double dG1_dxc        = phi*drhoaw_dxc;
            double dG1_dTheta     = phi*drhoaw_dTheta;
            double dG1_dU         = 0.0;

            double dG2_dxc        = phi*dHa_dxc;
            double dG2_dTheta     = dHr_dTheta + phi*dHa_dTheta;
            double dG2_dU         = 0.0;
            ...
            if (degree >= 2){
                ...
                double d2G0dxc2      = phi*d2rhoac_dxc2;
                double d2G0dxcdTheta = phi*d2rhoac_dxcdTheta;
                double d2G0dxcdU     = 0.0;

                double d2G0dThetadxc = d2G0dxcdTheta;
                double d2G0dTheta2   = phi*d2rhoac_dTheta2;
                ...
                double d2G1dxc2      = phi*d2rhoaw_dxc2;
                double d2G1dxcdTheta = phi*d2rhoaw_dxcdTheta;
                double d2G1dxcdU     = 0.0;

                double d2G1dThetadxc = d2G1dxcdTheta;
                double d2G1dTheta2   = phi*d2rhoaw_dTheta2;
                ...
                double d2G2dxc2      = phi*d2Ha_dxc2;
                double d2G2dxcdTheta = phi*d2Ha_dxcdTheta;
                double d2G2dxcdU     = 0.0;

                double d2G2dThetadxc = d2G2dxcdTheta;
                double d2G2dTheta2   = phi*d2Ha_dTheta2 + d2Hr_dTheta2;
